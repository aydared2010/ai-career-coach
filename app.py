...
# === КНОПКА ПРИМЕРА (ВВЕРХУ) ===
if st.button("📝 Заполнить пример", use_container_width=True):
    st.session_state.resume_text = """Python-разработчик, 3 года опыта.
...
with col1:
    ...
    # Text area с привязкой к session_state через key
    ...
    # Обновляем session_state при ручном вводе
