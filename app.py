...
if "resume_area" not in st.session_state:
    st.session_state.resume_area = ""
if "job_area" not in st.session_state:
    st.session_state.job_area = ""
...
with col1:
    ...
    if uploaded_file is not None:
        try:
            ...
            st.session_state.resume_area = pdf_text
