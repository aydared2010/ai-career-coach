...
st.markdown("Вставьте текст резюме и описание вакансии для мгновенного анализа от ИИ.")
...
with col2:
    ...
    job_description = st.text_area("Вставьте текст вакансии...", height=300)
        ...
        with st.spinner("ИИ анализирует данные..."):
            try:
                chat_completion = client.chat.completions.create(
                    messages=[
                        {"role": "system", "content": "Ты полезный AI-ассистент. Отвечай структурированно."},
